...
ML_file "~~/src/HOL/Tools/SMT/smt_util.ML"
ML_file "~~/src/HOL/Tools/SMT/smt_failure.ML"
ML_file "smt_config_patch.ML"
ML_file "~~/src/HOL/Tools/SMT/smt_builtin.ML"
ML_file "~~/src/HOL/Tools/SMT/smt_datatypes.ML"
ML_file "smt_normalize_patch.ML"
ML_file "~~/src/HOL/Tools/SMT/smt_translate.ML"
ML_file "smtlib_patch.ML"
ML_file "smtlib_interface_patch.ML"
ML_file "~~/src/HOL/Tools/SMT/smtlib_proof.ML"
ML_file "~~/src/HOL/Tools/SMT/smtlib_isar.ML"
ML_file "~~/src/HOL/Tools/SMT/z3_proof.ML"
ML_file "~~/src/HOL/Tools/SMT/z3_isar.ML"
ML_file "smt_solver_patch.ML"
(* We currently do not use CVC4 nor veriT so we remove them from the patch *)
(* ML_file "~~/src/HOL/Tools/SMT/cvc4_interface.ML"
ML_file "~~/src/HOL/Tools/SMT/cvc4_proof_parse.ML"
ML_file "~~/src/HOL/Tools/SMT/verit_proof.ML"
ML_file "~~/src/HOL/Tools/SMT/verit_isar.ML"
...
ML_file "z3_model.ML"
ML_file "smt_systems_patch.ML"

method_setup smt = \<open>
  Scan.optional Attrib.thms [] >>
    (fn thms => fn ctxt =>
      METHOD (fn facts => HEADGOAL (SMT_patch_Solver.smt_tac ctxt (thms @ facts))))
...
\<open>smt_status_patch\<close>, which shows the values of most options.
\<close>
...
solver. The possible values can be obtained from the \<open>smt_status_patch\<close>
command.
\<close>
