...
val c_get_state = _import "get_x" public : Int32.int -> Int32.int; 
...
fun get_state (taskid:Datatypes.int) (thid:Datatypes.int) (res:Datatypes.int) (state)=
    (SOME (Datatypes.Int_of_integer(IntInf.fromInt(c_get_state(IntInf.toInt (intOfInt res)))), 
	  state))
